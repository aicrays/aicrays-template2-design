  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-white via-purple-50/30 to-violet-50/40">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-[5%] left-[30%] w-64 h-64 bg-indigo-200/15 rounded-full blur-3xl animate-float-vertical opacity-45" style={{ animationDelay: '12s', animationDuration: '28s' }}></div>
        <div className="absolute bottom-[5%] right-[40%] w-52 h-52 bg-violet-300/18 rounded-full blur-3xl animate-float-vertical opacity-65" style={{ animationDelay: '18s', animationDuration: '23s' }}></div>
        ...
        <div className="absolute top-[45%] left-[5%] w-42 h-42 bg-purple-300/20 rounded-full blur-2xl animate-float-vertical opacity-55" style={{ animationDelay: '25s', animationDuration: '19s' }}></div>
        <div className="absolute bottom-[15%] right-[65%] w-38 h-38 bg-indigo-300/18 rounded-full blur-2xl animate-float-vertical opacity-60" style={{ animationDelay: '30s', animationDuration: '21s' }}></div>
        ...
        <div className="absolute top-[12%] left-[65%] w-16 h-16 bg-violet-400/22 rounded-full blur-lg animate-float-vertical opacity-50" style={{ animationDelay: '32s', animationDuration: '13s' }}></div>
        <div className="absolute bottom-[60%] left-[40%] w-14 h-14 bg-purple-300/26 rounded-full blur-lg animate-float-vertical opacity-55" style={{ animationDelay: '35s', animationDuration: '11s' }}></div>
        ...
        <div className="absolute top-[38%] left-[78%] w-9 h-9 bg-indigo-300/24 rounded-full blur-md animate-float-vertical opacity-48" style={{ animationDelay: '37s', animationDuration: '15s' }}></div>
        <div className="absolute bottom-[28%] right-[85%] w-11 h-11 bg-violet-300/20 rounded-full blur-lg animate-float-vertical opacity-52" style={{ animationDelay: '40s', animationDuration: '17s' }}></div>
        ...
        <div className="absolute top-[90%] right-[30%] w-2 h-2 bg-purple-500/48 rounded-full animate-float-vertical" style={{ animationDelay: '27s', animationDuration: '8s' }}></div>
        <div className="absolute bottom-[40%] left-[20%] w-4 h-4 bg-indigo-400/42 rounded-full animate-float-vertical" style={{ animationDelay: '33s', animationDuration: '11s' }}></div>
        <div className="absolute top-[8%] right-[15%] w-1.5 h-1.5 bg-violet-500/38 rounded-full animate-float-vertical" style={{ animationDelay: '36s', animationDuration: '6s' }}></div>
        <div className="absolute bottom-[70%] left-[85%] w-2.5 h-2.5 bg-purple-400/44 rounded-full animate-float-vertical" style={{ animationDelay: '39s', animationDuration: '9s' }}></div>
      </div>
