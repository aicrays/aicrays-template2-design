...
const HeroContent = () => {
  return <div className="w-full lg:w-1/2 text-left space-y-6 lg:space-y-8">
      ...
      <div className="space-y-4">
        <h1 className="font-bold leading-tight tracking-tight text-4xl md:text-5xl lg:text-6xl">
          <div className="opacity-0 animate-fade-in mb-4" style={{
          animationDelay: "0.2s",
      ...
      <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in pt-6" style={{
      animationDelay: "0.8s",
      animationDuration: "0.8s"
    }}>
