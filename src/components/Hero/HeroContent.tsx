  ...
  return (
    <div className="w-full max-w-5xl text-center space-y-8 px-4 -mt-12">
      ...
      >
        <a 
          href="#contact" 
          className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-purple-700 to-purple-800 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 overflow-hidden min-w-[250px] hover:shadow-purple-600/50 hover:from-purple-800 hover:to-purple-900"
        >
