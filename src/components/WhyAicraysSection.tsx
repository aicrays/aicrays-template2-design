    ...
    <section className="py-4 lg:py-6 relative overflow-hidden h-screen flex flex-col justify-center" id="why-aicrays">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10 max-w-6xl mx-auto" ref={sectionRef}>
        ...
        <div className="text-center mb-4 lg:mb-6">
          <div 
            className="inline-flex items-center justify-center px-2 py-1 rounded-full text-xs font-medium bg-white/80 backdrop-blur-sm text-purple-700 border border-purple-200/50 shadow-sm mb-2 opacity-0 animate-fade-in hover:scale-105 transition-transform cursor-pointer"
          ...
          <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-display font-bold leading-tight tracking-tight mb-2 opacity-0 animate-fade-in" style={{ animationDelay: "0.3s" }}>
