...
const ModularTechSection = () => {
  ...
  const components = [
    ...
    },
    {
      ...
      description: "Intuitive, role-based interfaces designed to enhance productivity, reduce friction, and elevate the end-user experience",
      hoverText: "Improves user adoption and operational clarity through smart design",
      gradient: "from-purple-400 to-purple-500"
    }
  ];
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-gray-50 via-white to-purple-50 relative overflow-hidden" id="solutions">
      {/* Background Elements */}
      ...
      <div className="section-container relative z-10" ref={sectionRef}>
          ...
          {components.map((component, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed group-hover:text-gray-700 transition-colors text-sm">
        ...
        <div className="text-center mt-16 opacity-0 animate-fade-in" style={{ animationDelay: "1.2s" }}>
          <div className="bg-gradient-to-r from-purple-50 to-white rounded-2xl p-8 border border-purple-100 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button 
                ...
                className="inline-flex items-center justify-center px-6 py-3 text-lg font-medium text-purple-600 bg-white border-2 border-purple-200 rounded-full hover:border-purple-300 hover:bg-purple-50 transition-all duration-300"
              >
                See Examples →
              </button>
            </div>
